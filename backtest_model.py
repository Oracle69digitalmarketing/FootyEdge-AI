...
def run_historical_backtest():
    print("📊 Fetching historical match data and predictions for validation...")
    ...
    if not pred_res.data or not match_res.data:
        print("⚠️ Insufficient historical data found in tables to evaluate performance metrics.")
        return
    ...
    if df.empty:
        print("⚠️ No completed matches found to verify model accuracy.")
        return
